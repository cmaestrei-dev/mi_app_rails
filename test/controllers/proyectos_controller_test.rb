...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference("Proyecto.count") do
      post proyectos_url, params: { proyecto: { descripcion: @proyecto.descripcion, nombre: @proyecto.nombre } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { descripcion: @proyecto.descripcion, nombre: @proyecto.nombre } }
